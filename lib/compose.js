...
exports.ComposeLoadPlugin = exports.ComposeResolvePlugin = exports.ComposeStartPlugin = exports.compose_transform = void 0;
 ...
 * @returns
 */
function compose_transform(code, ...tranform_func) {
    let result = code;
...
exports.compose_transform = compose_transform;
