 ...
 */
function makebundle(entryPoints, outfile, workdir, bundle = false) {
    return __awaiter(this, void 0, void 0, function* () {
        // 兼容 metro 的 插件
        const base_plugins = [(0, resolve_platform_1.platform_ResolvePlugin)("ios"), (0, entry_console_1.entry_add_console)()];
        const plugins = [
            ...base_plugins,
            (0, metro_preset_1.metro_perset_plugin)(),
            (0, import_calc_1.import_recording_plugin)(),
        ];
