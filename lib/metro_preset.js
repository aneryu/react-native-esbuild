                ...
                if (!res.errors || ((_a = res.errors) === null || _a === void 0 ? void 0 : _a.length) === 0) {
                    ...
                    outputFiles === null || outputFiles === void 0 ? void 0 : outputFiles.forEach((file) => {
                        ...
                        if (file.path.endsWith(".js")) {
                            const output_chunks_map = (0, split_1.split_esbuild_output_chunk)(file.text, (_a = build.initialOptions.absWorkingDir) !== null && _a !== void 0 ? _a : process.cwd(), (_b = Reflect.get(build.initialOptions, "import_records")) !== null && _b !== void 0 ? _b : new Map());
