...
const require_runtime_1 = require("./require-runtime");
/**
                    ...
                    if (char_perfix === "\n") {
                        if (char_perfix_txt.endsWith(".ts\n") ||
                            ...
                            if (stream.trim() !== "") {
                                ...
                                const final_code = (0, compose_1.compose_transform)(export_res.code, react_runtime_1.react_runtime, require_runtime_1.require_runtime);
